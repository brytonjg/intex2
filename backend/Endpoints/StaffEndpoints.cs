    ...
    public static void MapStaffEndpoints(this WebApplication app)
    {
        ...
        app.MapGet("/api/staff/tasks", async (HttpContext httpContext, UserManager<ApplicationUser> userManager, AppDbContext db, int? safehouseId) =>
        {
            ...
            var tasks = await query.OrderByDescending(t => t.CreatedAt)
                .Select(t => new { t.StaffTaskId, t.StaffUserId, t.ResidentId, residentCode = t.Resident != null ? t.Resident.InternalCode : null, residentFirstName = t.Resident != null ? t.Resident.FirstName : null, residentLastName = t.Resident != null ? t.Resident.LastName : null, t.SafehouseId, t.TaskType, t.Title, t.Description, t.ContextJson, t.Status, t.SnoozeUntil, t.DueTriggerDate, t.CreatedAt, t.SourceEntityType, t.SourceEntityId })
                .ToListAsync();
